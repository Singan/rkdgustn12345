...
<html>
  ...
  <body>
  	<form id="mForm" action="${pageContext.request.contextPath}/lunch/save.json">
  	<input id = "market" name="lunchName" placeholder = "가게이름"><br>
  	<input id = "lunchReview" name="lunchReview" placeholder = "평가"><br>
  	<input name="lunchRate" placeholder="점수"><br>
  	<textarea id = "addr" name="lunchAddr" placeholder = "주소" readonly="readonly"></textarea><br>
  	</form>
  	<button onclick="send();" type="button">저장</button>
