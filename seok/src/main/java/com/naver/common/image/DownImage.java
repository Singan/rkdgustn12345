package com.naver.common.image;
...
public class DownImage extends HttpServlet{
   ...
   public void down(
         File msgfile, HttpServletResponse response
         ) throws Exception {
      
	   msgfile.toString();
	   
      // 실제 저장된 파일명
      String sName = msgfile.getFileSystemName();
      // 다운로드 할 파일명
      String dName = msgfile.getFileOriginName();
      
      java.io.File f = new java.io.File(
            "C:/kang/upload" + msgfile.getFilePath(), sName);
